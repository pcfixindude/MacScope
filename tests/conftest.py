...
def _temp_database(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("macscope.workspaces.SessionLocal", database.SessionLocal)
    monkeypatch.setattr("macscope.usage.SessionLocal", database.SessionLocal)
    monkeypatch.setattr("macscope.automation.SessionLocal", database.SessionLocal)
    monkeypatch.setattr("macscope.recommendations.SessionLocal", database.SessionLocal)
